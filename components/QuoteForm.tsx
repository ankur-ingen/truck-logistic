...
export default function QuoteForm() {
    ...
    return (
        <section id="quote" className="py-24 bg-gradient-to-br from-blue-50 to-white">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                        <div>
                            <label htmlFor="movingFrom" className="block text-sm font-semibold text-gray-700 mb-2">
                        ...
                        <div>
                            <label htmlFor="movingTo" className="block text-sm font-semibold text-gray-700 mb-2">
